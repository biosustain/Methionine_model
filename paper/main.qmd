...
-data datasets. For the full dataset we obtained 1000 post-warmup samples each
from 4 independent Markov chains after 1000 warm-up samples and "hot-starting"
with a mass metric output by a previous model run.

For the missing-data dataset XXX.

For the Laplace approximation comparison, we used Maud’s Laplace mode. Full
details as well as instructions for reproducing our analysis can be found at
XXX.
